...
import { HttpRequest, HttpEventType, HttpResponse, HttpErrorResponse, HttpClient } from '@angular/common/http';
import { ɵɵdefineInjectable, ɵɵinject, Injectable, InjectionToken, Directive, ElementRef, Renderer2, Injector, Inject, Optional, PLATFORM_ID, Input, Component, ViewChild, ComponentFactoryResolver, ViewContainerRef, TemplateRef, isDevMode, SkipSelf, NgModule } from '@angular/core';
...
HttpClientUploadService.ɵprov = ɵɵdefineInjectable({ factory: function HttpClientUploadService_Factory() { return new HttpClientUploadService(ɵɵinject(NgxUploadLogger), ɵɵinject(HttpClient)); }, token: HttpClientUploadService, providedIn: "root" });
