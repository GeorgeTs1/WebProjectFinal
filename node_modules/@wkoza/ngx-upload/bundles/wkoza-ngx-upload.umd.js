(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.wkoza = global.wkoza || {}, global.wkoza['ngx-upload'] = {}), global.rxjs, global.ng.common.http, global.ng.core, global.ng.forms, global.ng.common));
}(this, (function (exports, rxjs, i2, i0, forms, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var HttpClientUploadService = /** @class */ (function () {
        ...
        HttpClientUploadService.prototype.uploadFileItem = function (fileItem, endpoint, options) {
            ...
            var req = new i2.HttpRequest(method, url, sendable, Object.assign(options, { reportProgress: true }));
            fileItem.sub = this.httpClient.request(req).subscribe(function (event) {
                ...
                if (err instanceof i2.HttpErrorResponse) {
    ...
    HttpClientUploadService.ɵprov = i0.ɵɵdefineInjectable({ factory: function HttpClientUploadService_Factory() { return new HttpClientUploadService(i0.ɵɵinject(NgxUploadLogger), i0.ɵɵinject(i2.HttpClient)); }, token: HttpClientUploadService, providedIn: "root" });
    ...
    var NGX_DROP_TARGET_OPTIONS = new i0.InjectionToken('Ngx drop Zone Options');
    var NGX_LOGGER_OPTIONS = new i0.InjectionToken('Ngx Logger Options');
    ...
    NgxDragAndDropDirective.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: i0.Inject, args: [NGX_DROP_TARGET_OPTIONS,] }] },
    ...
    NgxThumbnailDirective.propDecorators = {
        fileItem: [{ type: i0.Input, args: ['ngxThumbnail',] }]
    };
    ...
    InputfileComponent.propDecorators = {
        file: [{ type: i0.ViewChild, args: ['file', { static: true },] }]
    };
    ...
    function _loggerFactory(options) {
        var enabled = options.enabled ? options.enabled : i0.isDevMode();
        if (enabled) {
    ...
    var NGX_UPLOAD_ROOT_GUARD = new i0.InjectionToken('Internal forRoot Guard');
            ...
            return {
                ...
                providers: [
                    ...
                    },
                    {
                        ...
                        deps: [[NGX_LOGGER_OPTIONS, new i0.Optional(), new i0.SkipSelf()]]
                    }
                ]
            };
        };
